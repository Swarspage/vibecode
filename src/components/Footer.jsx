const SOCIALS = [
  {
    label: "Discord",
    url: "https://discord.com/users/itsme.3974",
    onClick: (e) => {
      e.preventDefault();
      navigator.clipboard.writeText("itsme.3974");
      alert("Discord ID 'itsme.3974' copied to clipboard!");
    },
    icon: (
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
          {SOCIALS.map((social) => (
            <a
              ...
              rel={social.onClick ? undefined : "noreferrer"}
              style={{
                color: "var(--color-muted)",
